...
#             token['organisation_id'] = user.member.organisation.id
#
#         return token
#
#     def validate(self, attrs):
...
#             # Ajouter l'ID de l'organisation au response
#             if hasattr(user, 'member'):
...
#                 {"detail": "Aucun compte actif trouvé avec les informations d'identification fournies"})
