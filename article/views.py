...
# from django.http import JsonResponse
# from django.views.decorators.csrf import csrf_exempt
# from .models import Categorie, Article  # Assurez-vous que ces modèles existent
...
#             categorie_id = request.POST.get('category_id')
...
#             # Vérifier si l'utilisateur a un profil "member"
#             try:
#                 member = request.user.member
#             except AttributeError:
#                 return JsonResponse({
#                     "message": "L'utilisateur n'a pas de profil membre.",
#                     "status": "error"
#                 }, status=400)
...
#             count, _ = Article.objects.all().delete()  # Delete renvoie le nombre d'objets supprimés

#             return JsonResponse({
#                 'status': 'success',
#                 'message': f'Tous les articles ont été supprimés. Nombre de arcticles supprimés: {count}'
#             }, status=200)  # 200 OK
