...
INSERT INTO `cart_cart` VALUES (4,11,'2024-08-30 20:38:43.365933'),(5,16,'2024-09-02 19:25:26.990886');
...
INSERT INTO `client` VALUES (4),(5),(6),(7),(8),(11),(12),(13),(14),(15),(16);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(11,'article','article'),(3,'auth','group'),(2,'auth','permission'),(7,'cart','cart'),(8,'cart','cartitem'),(12,'categorie','categorie'),(4,'contenttypes','contenttype'),(17,'order','order'),(18,'order','orderitem'),(6,'organisation','organisation'),(16,'passwordResetCode','passwordresetcode'),(10,'privilegies','privilegies'),(9,'rule','role'),(5,'sessions','session'),(14,'utilisateur','client'),(15,'utilisateur','member'),(13,'utilisateur','utilisateur');
...
CREATE TABLE `order_order` (
  ...
  `client_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `order_order_client_id_8dc70a8e_fk_client_utilisateur_ptr_id` (`client_id`),
  CONSTRAINT `order_order_client_id_8dc70a8e_fk_client_utilisateur_ptr_id` FOREIGN KEY (`client_id`) REFERENCES `client` (`utilisateur_ptr_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_orderitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_orderitem_article_id_77a11476_fk_article_article_id` (`article_id`),
  KEY `order_orderitem_order_id_aba34f44_fk_order_order_id` (`order_id`),
  CONSTRAINT `order_orderitem_article_id_77a11476_fk_article_article_id` FOREIGN KEY (`article_id`) REFERENCES `article_article` (`id`),
...
-- Dump completed on 2024-09-28 11:51:43
